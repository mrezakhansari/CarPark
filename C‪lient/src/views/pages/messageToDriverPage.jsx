...
import { Card, CardBody, Row, Col, Button, Modal, ModalBody, ModalHeader } from "reactstrap";
...
const MessageToDriverPage = (props) => {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        const temp = await getUserCarAssignInfoBasedOnQrCode({ id: props.match.params.id });
  ...
  return (
    <React.Fragment>
              ...
              <CardBody>
                ...
                </h2>
                {
                  ...
                  <Row>
                    ...
                    <Col sm="12" md="12" key={state.driverInfo.UserCarAssign_ID} className="customFont">
                        ...
                        textElement={
                          <React.Fragment>
                            <div className="customFont rtl">
                              <strong style={{ fontWeight: "5vw", textAlign: "center", direction: "ltr" }}>
                                {state.driverInfo.title}
                                ماشین: {state.driverInfo.Name}
                              </strong>
                              <hr />
                              <span style={{ fontWeight: "1vw", color: "white", textAlign: "center" }}>
                    ...
                    <Col className="mt-2" md="12">
                      <Button color="success" onClick={handleSendMessageToDriver}>ارسال پیام به راننده</Button>
                    </Col>
                  </Row>
                }
                {
      ...
      // dir="rtl"
      >
        <ModalHeader toggle={editToggle} className="customFont rtl" >ارسال پیغام به راننده</ModalHeader>
        <ModalBody className="text-center">
          <Row>

            <Col md="12">
              <Button color="primary" onClick={() => handleSubmitSendMessageToDriver(1,'  روغن ماشین در حال ریختن است')}>
                روغن ماشین در حال ریختن است
              </Button>
            </Col>
            <Col md="12">
              <Button color="danger" onClick={() => handleSubmitSendMessageToDriver(2,'بنزین ماشین در حال ریختن است')}>
            ...
            <Col md="12">
              <Button color="success" onClick={() => handleSubmitSendMessageToDriver(3,'جای پارک مناسب نیست')}>
                جای پارک مناسب نیست
              </Button>
            </Col>
            <Col md="12">
              <Button color="warning" onClick={() => handleSubmitSendMessageToDriver(5,' ماشین شما تصادف کرده')}>
